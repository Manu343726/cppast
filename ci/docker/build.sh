...
build()
{
    ...
    docker build $NO_CACHE --build-arg BOOST_VERSION=$BOOST_VERSION --build-arg BASE_IMAGE=$BASE_IMAGE $HOST_CC_ARG $HOST_CXX_ARG $CROSS_BUILDING_ARG --tag ${REPO}/${NAME}:${TAG} .
